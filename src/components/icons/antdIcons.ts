/*
 * @Description: 如果直接导入， ant-desig@icon 会全部打包进去，因此用此方法
 * @Autor: zdJOJO
 * @Date: 2020-10-01 18:58:19
 * @LastEditors: zdJOJO
 * @LastEditTime: 2020-10-17 18:48:52
 * @FilePath: \antd-cms\src\components\icons\antdIcons.ts
 */
...
export { default as UserOutlined } from '@ant-design/icons/UserAddOutlined';
